...
const SECTIONS: { title: string; body: string }[] = [
  ...
  {
    title: '開示される連絡先について',
    body: '成約時に依頼者・職人間で開示される連絡先は、登録された「メールアドレス」のみです。電話番号・住所・LINE IDなど、その他の個人情報は開示されません。',
  },
  {
    title: 'LINEおよびSNSの使用について',
    body: 'PRO MATCHは、お客様・職人のLINEアカウントや各種SNSを収集・使用しません。成約前に外部SNS・LINEへ誘導する行為は利用規約上の禁止事項です。',
  },
  {
    title: '動画・画像のアップロードについて',
    body: '動画や写真をアップロードする際は、映り込む個人情報（氏名・表札・郵便物・免許証など）にご注意ください。アップロードされたファイルは、見積もり・マッチング目的にのみ使用します。第三者への転用・販売は行いません。',
  },
  {
    title: '第三者への提供',

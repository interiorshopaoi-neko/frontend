  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <nav className="border-t border-slate-100">
            <div className="flex max-w-2xl mx-auto">
              <button
                ...
                className="flex-1 py-2.5 text-xs font-bold border-b-2 border-transparent text-slate-400 hover:text-slate-600 transition"
              >
                依頼内容
              </button>
              <div className="flex-1 py-2.5 text-xs font-bold border-b-2 border-blue-600 text-blue-600 text-center">
                応募状況
              </div>
              <button
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 pb-16">
        ...
        {/* 依頼内容・追加情報への案内カード */}
        {id && !isDemo && (
          <div className="mb-4 rounded-2xl bg-blue-50 border border-blue-100 px-4 py-4">
            <p className="text-xs font-extrabold text-blue-800 mb-1">依頼内容を確認・追加情報を送れます</p>
            <p className="text-[11px] text-blue-600 leading-relaxed mb-3">
              写真や動画を追加すると、職人が判断しやすくなります。
            </p>
            <div className="flex gap-2">
              <button
                onClick={() => navigate(`/request/${id}`)}
                className="flex-1 py-2 rounded-xl bg-white border border-blue-200 text-blue-700 font-bold text-xs hover:bg-blue-50 transition active:scale-95"
              >
                依頼内容を見る
              </button>
              <button

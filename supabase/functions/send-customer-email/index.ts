              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td style="padding:0 0 16px;">
                  <table cellpadding="0" cellspacing="0"><tr>
                    ...
                    <td>
                      <p style="margin:0;font-size:11px;font-weight:700;color:#94a3b8;">2営業日以内</p>
                      <p style="margin:3px 0 0;font-size:13px;color:#475569;">対応できる職人からメールでご連絡します</p>
                    </td>
                  </tr></table>
                </td></tr>
                <tr><td>
                  <table cellpadding="0" cellspacing="0"><tr>
                    ...
                    <td>
                      <p style="margin:0;font-size:11px;font-weight:700;color:#94a3b8;">5日後を目安</p>
                      <p style="margin:3px 0 0;font-size:13px;color:#475569;">反応がない場合、募集を続けるかご確認します</p>
                    </td>
                  </tr></table>
                </td></tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 32px 0;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4;border:1px solid #d1fae5;border-radius:12px;">
                ...
                <tr><td style="padding:6px 18px;">
                  <p style="margin:0;font-size:13px;color:#065f46;"><span style="color:#10b981;font-weight:700;">✓</span>&nbsp; ご連絡はメールのみです</p>
                </td></tr>
                <tr><td style="padding:6px 18px;">
                ...
                <tr><td style="padding:6px 18px 12px;">
                  <p style="margin:0;font-size:13px;color:#065f46;"><span style="color:#10b981;font-weight:700;">✓</span>&nbsp; 工事代金は職人と直接お支払いください</p>
                </td></tr>
              </table>
            </td>
          </tr>
